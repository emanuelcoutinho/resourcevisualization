...
public class Disco {
    ...
    private XYDataset  createDataset() throws IOException {
        TimeSeries timeseries4 = new TimeSeries("Leitura");
        TimeSeries timeseries5 = new TimeSeries("Escrita");
    ...
    public void criaGrafico(JPanel jPanel1) throws IOException {
        JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("Disco", "Data", "Kb/s", createDataset(), true, true, false);
