...
public class XYBarChartDemo1 extends ApplicationFrame {
    ...
    private static IntervalXYDataset createDataset() {
        ...
        try {
            ...
            timeseries.add(new Year(2006), new Integer(60));
            timeseries.add(new Year(2007), new Integer(60));
            timeseries.add(new Year(2008), new Integer(60));
            timeseries.add(new Year(2009), new Integer(60));
            timeseries.add(new Year(2010), new Integer(60));
            timeseries.add(new Year(2011), new Integer(610));
