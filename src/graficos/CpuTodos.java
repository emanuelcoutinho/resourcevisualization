...
public class CpuTodos {
    ...
    public CpuTodos(int mv) {
        this.mv = mv;
    }

    private XYDataset createDataset() throws IOException {
        TimeSeries timeseries1 = new TimeSeries("Usuário MV1");
        TimeSeries timeseries2 = new TimeSeries("Sistema MV1");
        TimeSeries timeseries3 = new TimeSeries("Ocioso MV1");

        TimeSeries timeseries4 = new TimeSeries("Usuário MV2");
        TimeSeries timeseries5 = new TimeSeries("Sistema MV2");
        TimeSeries timeseries6 = new TimeSeries("Ocioso MV2");

        TimeSeries timeseries7 = new TimeSeries("Usuário MV3");
        TimeSeries timeseries8 = new TimeSeries("Sistema MV3");
        TimeSeries timeseries9 = new TimeSeries("Ocioso MV3");

        TimeSeries timeseries10 = new TimeSeries("Usuário MV4");
        TimeSeries timeseries11 = new TimeSeries("Sistema MV4");
        TimeSeries timeseries12 = new TimeSeries("Ocioso MV4");
        ...
        for (int i = 0; i < l1.size(); i++) {
            try {
                ...
                Logger.getLogger(CpuTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        for (int i = 0; i < l2.size(); i++) {
            try {
               ...
               // RegularTimePeriod p = new Millisecond(i, 1, 1, 1, 1, 1, 2000);
                ...
                timeseries5.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuSys())));
                timeseries6.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuIdle())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(CpuTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for (int i = 0; i < l3.size(); i++) {
            try {
                ...
                Date d = Datas.stringToDataShellScript(log.getData());
                RegularTimePeriod p = new Millisecond(d);
                timeseries7.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuUser())));
                timeseries8.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuSys())));
                timeseries9.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuIdle())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(CpuTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for (int i = 0; i < l4.size(); i++) {
            try {
                ...
                Date d = Datas.stringToDataShellScript(log.getData());
                RegularTimePeriod p = new Millisecond(d);
                timeseries10.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuUser())));
                timeseries11.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuSys())));
                timeseries12.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getCpuIdle())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(CpuTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void criaGrafico(JPanel jPanel1) throws IOException {
        JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("CPU nas MVs", "Data", "% CPU", createDataset(), true, true, false);
