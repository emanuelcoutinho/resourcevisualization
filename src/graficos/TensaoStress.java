...
//        //timeseriescollection.addSeries(timeseries5);
    ...
    public void criaGrafico(JPanel jPanel1) throws IOException {
        JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("Tensão e Stress", "", "", createDataset(), true, true, false);
...
//        xyitemrenderer.setSeriesPaint(4, Color.DARK_GRAY);
