...
public class RedeTodos {
    ...
    public RedeTodos(int mv) {
        this.mv = mv;
    }

    private XYDataset createDataset() throws IOException {
        TimeSeries timeseries1 = new TimeSeries("Pacotes Recebidos MV1");
        TimeSeries timeseries2 = new TimeSeries("Pacotes Enviados MV1");
        TimeSeries timeseries3 = new TimeSeries("Pacotes Recebidos MV2");
        TimeSeries timeseries4 = new TimeSeries("Pacotes Enviados MV2");
        TimeSeries timeseries5 = new TimeSeries("Pacotes Recebidos MV3");
        TimeSeries timeseries6 = new TimeSeries("Pacotes Enviados MV3");
        TimeSeries timeseries7 = new TimeSeries("Pacotes Recebidos MV4");
        TimeSeries timeseries8 = new TimeSeries("Pacotes Enviados MV4");
        ...
        for (int i = 0; i < l1.size(); i++) {
            try {
                ...
                timeseries1.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeIn())));
                timeseries2.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeOut())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(RedeTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        for (int i = 0; i < l2.size(); i++) {
            try {
                ...
                Date d = Datas.stringToDataShellScript(log.getData());
                RegularTimePeriod p = new Millisecond(d);
                timeseries3.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeIn())));
                timeseries4.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeOut())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(RedeTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for (int i = 0; i < l3.size(); i++) {
            try {
                ...
                Date d = Datas.stringToDataShellScript(log.getData());
                RegularTimePeriod p = new Millisecond(d);
                timeseries5.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeIn())));
                timeseries6.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeOut())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(RedeTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for (int i = 0; i < l4.size(); i++) {
            try {
                ...
                Date d = Datas.stringToDataShellScript(log.getData());
                RegularTimePeriod p = new Millisecond(d);
                timeseries7.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeIn())));
                timeseries8.addOrUpdate(p, Double.parseDouble(String.valueOf(log.getRedeOut())));
                System.out.println(log.toString());
            } catch (ParseException ex) {
                Logger.getLogger(RedeTodos.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void criaGrafico(JPanel jPanel1) throws IOException {
        JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("Rede nas MVs", "Data", "Kb/s", createDataset(), true, true, false);
